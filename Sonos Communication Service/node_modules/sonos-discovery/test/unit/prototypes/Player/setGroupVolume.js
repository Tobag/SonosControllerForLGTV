...
describe('Player.setGroupVolume', function () {
  var setGroupVolume = require('../../../../lib/prototypes/Player/setGroupVolume.js');
  var players = void 0;
  ...
  describe('When setting fixed group volume', function () {

    beforeEach(function () {
      return setGroupVolume.call(coordinator, 10);
    });

    it('should have called setVolume on all players', function () {
    ...
    it('Should have updated groupState to match desired volume', function () {
      expect(coordinator.groupState.volume).to.equal(10);
    });
  });

  describe('When setting relative negative group volume', function () {
  ...
  describe('When setting relative positive group volume', function () {
