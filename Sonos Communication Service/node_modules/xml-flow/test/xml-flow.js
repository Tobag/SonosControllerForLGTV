  ...
  describe(".on('tag:...')", function () {
    ...
    it('should make non-attributed data look really simple', function (done) {
      var simpleStream = getFlow('./test/test.xml'),
          output = {
        $name: 'no-attrs',
        person: [{ name: 'Bill', id: '1', age: '27' }, { name: 'Joe', id: '2', age: '29' }, { name: 'Smitty', id: '3', age: '37' }]
      };
    ...
    it('should handle tags with both attributes and other stuff', function (done) {
      var simpleStream = getFlow('./test/test.xml'),
          output = {
        $name: 'mixed',
        person: [{ $attrs: { name: 'Bill', id: '1', age: '27' }, $text: 'some text' }, { $attrs: { name: 'Joe', id: '2', age: '29' }, p: 'some paragraph' }, { $attrs: { name: 'Smitty', id: '3', age: '37' }, thing: { id: '999', ref: 'blah' } }]
      };
    ...
    it('should preserve markup when things get more complex', function (done) {
      var simpleStream = getFlow('./test/test.xml'),
          output = {
        $name: 'markup',
        $markup: ['Some unwrapped text', { $name: 'person', $attrs: { name: 'Bill', id: '1', age: '27' }, $text: 'some text' }, 'Some more unwrapped text', { $name: 'person', $attrs: { name: 'Joe', id: '2', age: '29' }, p: 'some paragraph' }, { $name: 'person', $attrs: { name: 'Smitty', id: '3', age: '37' }, thing: { id: '999', ref: 'blah' } }]
      };
    ...
    it('should handle scripts', function (done) {
      var simpleStream = getFlow('./test/test.xml'),
          output = {
        $name: 'has-scripts',
        script: ['var x = 3;', { $attrs: { type: 'text/javascript' }, $script: '//this is a comment' }]
      };
    ...
    it('should handle bad formatting', function (done) {
      var simpleStream = getFlow('./test/badFormatting.xml'),
          output = {
        $name: 'section',
        $markup: ['Text1</p>', { $name: 'p', $text: 'Text2' }, { $name: 'p', $text: 'Text3' }, 'Text4', { $name: 'p' }]
      };
