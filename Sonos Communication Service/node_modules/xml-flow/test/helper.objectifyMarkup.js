...
describe('helper.objectifyMarkup()', function () {
  it('should add object array properties from $markup', function () {
    ...
    input = {
      $name: 'root',
      $attrs: {},
      $markup: ['text', [{ $name: 'item', $text: 'something' }, { $name: 'item', $text: 'else' }]]
    };
  ...
  it('should aggregate everything from $markup', function () {
    ...
    input = {
      $name: 'root',
      $attrs: {},
      $markup: ['text', [{ $name: 'item', $text: 'something' }, { $name: 'item', $text: 'else' }], 'text', { $name: 'item', $text: 'otherwise' }]
    };
  ...
  it('should preserve arrays if asked', function () {
    ...
    input = {
      $name: 'root',
      $attrs: {},
      $markup: ['text', { $name: 'item', $text: 'something' }]
    };
