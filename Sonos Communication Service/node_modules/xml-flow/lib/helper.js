...
exports.escape = function escape(string) {
  ...
  return result && reHasUnescapedHtml.test(result) ? result.replace(reUnescapedHtml, function replacement(chr) {
...
exports.simplifyNode = function simplifyNode(node, dropName, keepArrays) {
  ...
  if (node === null || (typeof node === 'undefined' ? 'undefined' : _typeof(node)) !== 'object') return shallowClone(node);
...
exports.moosh = function moosh(item1, item2, useArrays) {
  if (item1 === undefined) {
    if (item2 !== null && (typeof item2 === 'undefined' ? 'undefined' : _typeof(item2)) === 'object' && item2.constructor === Array && item2.length === 1) {
  ...
  if (item2 === undefined) {
    if (item1 !== null && (typeof item1 === 'undefined' ? 'undefined' : _typeof(item1)) === 'object' && item1.constructor === Array && item1.length === 1) {
      return useArrays ? item1 : item1[0];
    }
    return useArrays ? [item1] : item1;
  }

  if (item1 !== null && (typeof item1 === 'undefined' ? 'undefined' : _typeof(item1)) === 'object' && item1.constructor === Array) {
    if (item2 !== null && (typeof item2 === 'undefined' ? 'undefined' : _typeof(item2)) === 'object' && item2.constructor === Array) {
...
function simplifyAll(input, dropName) {
  var output = [];
  if (input !== null && (typeof input === 'undefined' ? 'undefined' : _typeof(input)) === 'object' && input.constructor === Array) {
